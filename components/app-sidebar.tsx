  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (formData.provider === "aws") {
        const awsServices = ["EC2", "S3", "RDS", "Lambda", "CloudFront", "IAM", "VPC"]
              ...
              <SidebarMenu>
                {configs.map((config) => (
                  <SidebarMenuItem key={config.id}>
                    ...
                    <SidebarMenuBadge className="bg-destructive text-destructive-foreground top-1/2 -translate-y-1/2">
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={closeDialog}>
        <DialogContent className="sm:max-w-[525px]">
          <DialogHeader>
            ...
            <DialogDescription>Connect to your cloud provider to scan for misconfigurations.</DialogDescription>
          </DialogHeader>
          ...
          {!isLoading && !extractedConfig ? (
                ...
                <TabsContent value="basic" className="mt-4">
                  <div className="grid gap-4 py-4">
                    <div className="grid gap-2">
                      ...
                      />
                      {formErrors.name && <p className="text-sm text-destructive">Configuration name is required</p>}
                    </div>
                    <div className="grid gap-2">
                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        className={formErrors.access_key ? "border-destructive" : ""}
                      />
                      {formErrors.access_key && <p className="text-sm text-destructive">Access key is required</p>}
                    </div>
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        className={formErrors.secret_key ? "border-destructive" : ""}
                      />
                      {formErrors.secret_key && <p className="text-sm text-destructive">Secret key is required</p>}
                    </div>
                    <div className="grid gap-2">
                      ...
                      />
                      {formErrors.region && <p className="text-sm text-destructive">Region is required</p>}
                    </div>
                  </div>
                </TabsContent>
              </Tabs>
            ...
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <p className="text-center font-medium">Extracting the configuration...</p>
              <p className="text-center text-sm text-muted-foreground mt-2">
                This may take a few moments while we analyze your cloud resources.
              </p>
            </div>
          ) : extractedConfig ? (
            <div className="py-4">
              <Alert className="mb-4 bg-green-50 border-green-200">
                <AlertDescription className="text-green-800">Configuration successfully extracted!</AlertDescription>
              </Alert>

              <div className="space-y-4">
                <div>
                  <h3 className="font-medium mb-2">Discovered Resources</h3>
                  <p className="text-2xl font-bold">{extractedConfig.resources}</p>
                </div>
